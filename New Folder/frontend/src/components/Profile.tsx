...
// const deleteAddress = async (token: string, addressId: string) => {
//   try {
//     const response = await api.delete(`/delete-addresses/${addressId}`, {
//       headers: {
//         Authorization: `Bearer ${token}`,
//       },
//     });
...
//         .then(() => {
//           setAddress(prevAddresses => prevAddresses.filter(addr => addr.id !== addressToDelete));
...
//                   <Button variant="danger" onClick={() => openDeleteConfirmation(addr.id)}>
//                     Delete
//                   </Button>
//                 </li>
//               ) : (
//                 <li key={index}>Please Refer to update new address</li>
//               )
//             ))}
//           </ul>
//         )}
            ...
            {address.map((addr: any, index: number) => (
              addr && addr.street && addr.city && addr.state && addr.pincode ? (
                <li key={index}>
                  ...
                  {/* <Button variant="danger" onClick={() => openDeleteConfirmation(addr.uuid)}>
                    Delete
                  </Button> */}
                </li>
              ) : (
                <li key={index}>Please refer to update the address</li>
              )
            ))}
          </ul>
        )}
