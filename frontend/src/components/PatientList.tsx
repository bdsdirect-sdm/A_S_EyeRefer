...
const PatientList:React.FC = () => {
  ...
  return (
    <>
        ...
        <div className='d-flex' >
          ...
          <input className='form-control w-25 border border-dark mx-3 mb-5' type="search" name="find" value={Input} placeholder='search......' onChange={(e:any)=>{setInput(e.target.value)}} />
  ...
  <tbody>
    {Patients?.patientList?.map((patient:any) =>(
      <>
      <tr>
