...
const AppointmentList: React.FC = () => {
  ...
  return (
    <>
    <div>
      <Link to='/add-appointment' className='btn btn-outline-dark float-end' >Add Appointment</Link>
    </div>
    <br /><br /><br />
          ...
          <div className="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                Are you sure, want to complete the appointment with FFFLF.
                </div>
                <div className="modal-footer">
                  <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                  <button type="button" className="btn btn-primary" onClick={()=>{
                    // Update Status to Complete i.e., 3
                  }} >Save</button>
                </div>
              </div>
            </div>
          ...
          <div className="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  Are you sure, want to cancel the appointment with FFFLF.
                </div>
                <div className="modal-footer">
                  <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                  <button type="button" className="btn btn-primary" onClick={()=>{
                    // Update Status to Cancel i.e., 2
                  }} >Save</button>
                </div>
              </div>
            </div>
